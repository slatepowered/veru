...
public abstract class TextComponent {
    ...
    public static LiteralComponent text(String text) {
        return new LiteralComponent(text);
    }

    public static CompoundComponent parse(String text) {
        return TextComponentParsing.parseLegacyPlusLike(new StringReader(text), '&');
    }
