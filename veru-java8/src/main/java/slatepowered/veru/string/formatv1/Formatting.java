package slatepowered.veru.string.formatv1;
...
public interface Formatting {
    ...
    Formatting ANSI = new CommonFormatting() {
        ...
        public void enableCommonColor(StringBuilder b, CommonColor color) {
            String code = null;
            switch (color) {
                case RED: code = slatepowered.veru.misc.ANSI.RED; break;
                case BLUE: code = slatepowered.veru.misc.ANSI.BLUE; break;
                case GREEN: code = slatepowered.veru.misc.ANSI.GREEN; break;
                case YELLOW: code = slatepowered.veru.misc.ANSI.YELLOW; break;
                case AQUA:
                case CYAN: code = slatepowered.veru.misc.ANSI.CYAN; break;
                case PURPLE: code = slatepowered.veru.misc.ANSI.PURPLE; break;
                case BLACK: code = slatepowered.veru.misc.ANSI.BLACK; break;
                case WHITE: code = slatepowered.veru.misc.ANSI.WHITE; break;
            }
        ...
        public void enableTrueColor(StringBuilder b, Color color) {
            b.append(slatepowered.veru.misc.ANSI.getRGBForeground(color.getRed(), color.getGreen(), color.getBlue()));
        }

        @Override
        public void reset(StringBuilder b) {
            b.append(slatepowered.veru.misc.ANSI.RESET);
        }
    };
